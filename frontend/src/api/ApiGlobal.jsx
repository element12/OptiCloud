...
const usuariosApi = axios.create({
  baseURL: import.meta.env.VITE_API_USER || "https://usuarios-api.azurewebsites.net",
  headers: {
...
const catalogoInventarioApi = axios.create({
  baseURL: import.meta.env.VITE_API_CATALOGO_INVENTARIO || "https://catalogo-inventario-ebhue0g4cwfyemg7.centralus-01.azurewebsites.net",
  headers: {
    "Content-Type": "application/json",
  },
});
...
const gestionPacienteApi = axios.create({
  baseURL: import.meta.env.VITE_API_GESTION_PACIENTE || "https://gestionpacienteopticloud.azurewebsites.net",
  headers: {
    "Content-Type": "application/json",
  },
});
...
const historialOptometricoApi = axios.create({
  baseURL: import.meta.env.VITE_API_HISTORIAL_OPTOMETRICO || "https://historialoptometrico.azurewebsites.net",
  headers: {
    "Content-Type": "application/json",
  },
});
